...
def load_models():
    ...
    """
    text_model_pro = genai.GenerativeModel("gemini-1.0-pro")
    multimodal_model_pro = genai.GenerativeModel("gemini-1.0-pro-vision")
...
with tab3:
    ...
    with image_undst:
        ...
        room_image = 'room_image_urls'
        chair_1_image = 'chair_1_image_urls'
        chair_2_image = 'chair_2_image_urls'
        chair_3_image = 'chair_3_image_urls'
        chair_4_image = 'chair_4_image_urls'
    ...
    with screens_undst:
        ...
        stove_screen_img = ' stove_screen_url'
...
"""
    ...
    with recommendations:
        ...
        compare_img_1_img = 'compare_img_1_url'
        compare_img_2_img = 'compare_img_2_url'
        face_type = st.radio(
